...
class Lead
{
     ...
     * It is also possible for fields in list parameters to be ignored arbitrarily;
     * Few lists appear to support LIMIT;
     * Some lists appear to support '%' in field values, thus enabling custom wildcards;
     ...
     * Particular list may not support some filtering conditions;
     *
     * 'ORDER':
     * => [ ... [ fieldName => 'ASC' | 'DESC' ] ]
     *
     ...
     * => [ ... fieldName ]
     *
     * Defines what to include in list results
     * 'ID' - id or any other identity is always selected
     *
     ...
     * => int
     *
     * Offset given in a previous list response to continue from
     *
     * Some endpoints also offer 'navigation' parameter which seemingly does the same???
     *
     * 'FILTER':
     * => [ ... [ filterType.fieldName => filterValue ] ]
     *
     * possible filterType:
